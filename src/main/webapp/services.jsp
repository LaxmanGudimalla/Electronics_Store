...
<head>
    <meta charset="UTF-8">
    <title>Services - Electronic Store</title>
    <style>
        ...
        .content ul { font-size: 18px; line-height: 1.8; }
...
<div class="navbar">
    ...
    <div class="content">
        <h1>Our Services</h1>
<ul>
    <li>Latest Electronics at Best Prices</li>
    <li>Fast and Reliable Delivery</li>
    <li>24/7 Customer Support</li>
    <li>Easy Returns & Exchange Policy</li>
    <li>Secure Online Payments</li>
    <li>Wide Range of Gadgets and Accessories</li>
    <li>Warranty and After-Sales Assistance</li>
    <li>Regular Discounts and Special Offers</li>
    <li>User-Friendly Online Shopping Experience</li>
    <li>Product Comparisons and Expert Recommendations</li>
    <li>Dedicated Support for Bulk/Corporate Orders</li>
</ul>
